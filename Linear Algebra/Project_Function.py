...
#Matrix basic operation: Multiplication
...
#Matrix basic operation: Scalar multiplication
def matrix_scalar_product(k,mat):
    if type(mat) == list and len(mat) != 0 and len(mat[0]) != 0:
        result = []
